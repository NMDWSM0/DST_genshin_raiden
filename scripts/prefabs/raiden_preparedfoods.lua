...
local function MakePreparedFood(data)
    local foodassets =
    {
        ...
        Asset("IMAGE", "images/inventoryimages/raiden_preparedfoods.tex"),
        Asset("ATLAS", "images/inventoryimages/raiden_preparedfoods.xml"),
    }
    ...
    local function fn()
        ...
        if spicename ~= nil then
			...
			inst.AnimState:OverrideSymbol("swap_garnish", data.overridespicebuild or "spices", spicename)

            inst:AddTag("spicedfood")

            inst.inv_image_bg = { image = (data.basename or data.name)..".tex" }
            inst.inv_image_bg.atlas = "images/inventoryimages/raiden_preparedfoods.xml"
        ...
        elseif data.basename ~= nil then
            inst.components.inventoryitem.atlasname = "images/inventoryimages/raiden_preparedfoods.xml"
...
for k, v in pairs(require("import/raiden_preparedfoods")) do
