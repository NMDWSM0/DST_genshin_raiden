...
TUNING.ENGULFINGLIGHTNING_DAMAGE = 41
TUNING.ENGULFINGLIGHTNING_ATKUP_RATE = 0.28
TUNING.ENGULFINGLIGHTNING_ATKUP_MAX = 0.8
TUNING.ENGULFINGLIGHTNING_RECHARGEUP = 0.3

TUNING.FAVONIUSLANCE_DAMAGE = 37
TUNING.FAVONIUSLANCE_EFFECT_CD = 6
TUNING.FAVONIUSLANCE_TRIGGER_RATE = 1

TUNING.THECATCH_DAMAGE = 34
TUNING.THCATCH_CRIT_RATE = 0.12
TUNING.THECATCH_ELEBURST_BONUS = 0.32
...
--------------------------------------
--厨艺经验
TUNING.FIREPIT_EXPDELTA = 3
TUNING.COOKPOT_EXPDELTA = 10
